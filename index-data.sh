...
PRODUCTS_JSON_FILE="/workspace/search_with_machine_learning_course/conf/week4/bbuy_products.json"
QUERIES_JSON_FILE="/workspace/search_with_machine_learning_course/conf/week4/bbuy_queries.json"
